...
\033[38;5;46m    __    __ _     __    _  _     __    _  _  __ __      ___ __ _          
\033[38;5;46m| ||_ |  /  / \|V||_    |_)|_||\|/__|  |_|| \|_ (_ |_|    | |_ |_||V|      
\033[38;5;46m|^||__|__\__\_/| ||__   |_)| || |\_||__| ||_/|____)| |    | |__| || |      
\033[38;5;46m_  _  _           __ _     __\ / _  __ _     __ _             ______\ /   
\033[38;5;46m| \|_||_)|/    | ||_ |_)   /   Y |_)|_ |_)   /  / \|V||V|| ||\| |  |  Y    
\033[38;5;46m|_/| || \|\    |^||__|_)   \__ | |_)|__| \   \__\_/| || ||_|| |_|_ |  |    
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://www.facebook.com/DARKWEBCYBERCOMMUNITY404")
				...
				print()
				print("\033[1;91m[*] \033[1;97mOpening my WhatsApp  in your device \n")
				time.sleep(1)
